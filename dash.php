...
<form method="post" action="angket.php" enctype="multipart/form-data">

   
    <input type="text" id="angket" name="angket" placeholder="kalimat angket" style="width: 50%;
    padding: 12px 20px;
    margin: 8px 0;
    ...
    <input name="daftar" type="submit" value="Tambah" style="width: 15%;
